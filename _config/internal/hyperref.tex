...
\ifthesis@draft\else
\AtBeginDocument{%
   % \translate is robust and would survive into the PDF string unexpanded,
   % \translatelet hands us the plain replacement text instead
   {\translatelet\@subject{\thesis@type}\def\nl{\space}%
   \hypersetup{%
      pdftitle={\@title},
      pdfauthor={\@author},
      pdfsubject={\@subject}
