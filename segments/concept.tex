...
A figure that is too small to deserve a float of its own is a good candidate for the margin:\sidenote{%
    \centering
    \includegraphics[width=.8\linewidth]{img/example}%
    \captionof{figure}{A figure within the margin.}%
    \label{fig:sidenote}%
}
